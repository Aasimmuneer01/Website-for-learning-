      ...
      <section className="px-6 relative">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-surface p-8 rounded-2xl border border-secondary/50 shadow-lg hover:-translate-y-2 transition-transform">
            ...
            <h3 className="text-xl font-bold text-white mb-2 uppercase tracking-wide">Vast Library</h3>
          ...
          <div className="bg-surface p-8 rounded-2xl border border-secondary/50 shadow-lg hover:-translate-y-2 transition-transform">
            ...
            <h3 className="text-xl font-bold text-white mb-2 uppercase tracking-wide">Easy Download</h3>
          ...
          <div className="bg-surface p-8 rounded-2xl border border-secondary/50 shadow-lg hover:-translate-y-2 transition-transform relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold text-white mb-2 uppercase tracking-wide">Online Viewer</h3>
      ...
      <section className="px-6 py-12">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
           <div className="flex-1 space-y-6">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-white uppercase tracking-tighter leading-tight">
              ...
              <div className="grid grid-cols-2 gap-6 pt-4">
                 <div>
                    <h4 className="text-white font-bold mb-1">Web Design & Resources</h4>
                    <p className="text-gray-500 text-sm">Optimized for every device.</p>
                 </div>
                 <div>
                    <h4 className="text-white font-bold mb-1">Discover Innovation</h4>
                 ...
                 <div>
                    <h4 className="text-white font-bold mb-1">SEO Optimized</h4>
           ...
           <div className="flex-1 w-full relative">
              <div className="bg-surface rounded-2xl overflow-hidden shadow-2xl relative pt-[60%]">
                 ...
                 <div className="absolute bottom-6 left-6 right-6 p-6 bg-surface/80 backdrop-blur-md border border-secondary rounded-xl">
                   <h3 className="text-white font-bold uppercase tracking-wide">Transforming Ideas Into Visual Masterpieces</h3>
                 </div>
              </div>
           </div>
        </div>
